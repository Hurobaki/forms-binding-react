...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FormFACC", function() { return FormFACC; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "withForm", function() { return withForm; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(281);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_prop_types__ = __webpack_require__(282);
...
var FormFACCComponent =
/*#__PURE__*/
function (_Component) {
  _inherits(FormFACCComponent, _Component);

  function FormFACCComponent() {
    var _getPrototypeOf2;

    var _this;

    _classCallCheck(this, FormFACCComponent);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(FormFACCComponent)).call.apply(_getPrototypeOf2, [this].concat(args)));
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "validate", function () {
      var _this$state = _this.state,
          predicates = _this$state.predicates,
          fields = _this$state.fields,
          customPredicates = _this$state.customPredicates;

      _this.setState({
        errors: {}
      });

      var _Object$keys$reduce = Object.keys(predicates).reduce(function (acc, curr) {
        var error = !predicates[curr](fields[curr]) ? _defineProperty({}, curr, true) : {};
        return {
          errorsPredicates: _objectSpread({}, acc.errorsPredicates, error)
        };
      }, {
        errorsPredicates: {}
      }),
          errorsPredicates = _Object$keys$reduce.errorsPredicates;

      var _Object$keys$reduce2 = Object.keys(customPredicates).reduce(function (acc, item) {
        var error = !customPredicates[item]["validator"](fields) ? _defineProperty({}, customPredicates[item]["name"], true) : {};
        return {
          errorsCustomPredicates: _objectSpread({}, acc.errorsCustomPredicates, error)
        };
      }, {
        errorsCustomPredicates: {}
      }),
          errorsCustomPredicates = _Object$keys$reduce2.errorsCustomPredicates;

      var errors = _objectSpread({}, errorsPredicates, errorsCustomPredicates);
    ...
    function () {
      ...
      regeneratorRuntime.mark(function _callee(event) {
        var formField, isDynamic;
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                formField = _defineProperty({}, event.target.name, event.target.value);
                isDynamic = _this.props.isDynamic;
                _context.next = 4;
                return _this.setState(function (prevState) {
                  return {
                    fields: _objectSpread({}, prevState.fields, formField)
                  };
                });

              case 4:
                isDynamic && _this.validate();
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleSubmit", function (event) {
      var isDynamic = _this.props.isDynamic;
      var formValid = _this.state.formValid;
      event.preventDefault();
      !isDynamic && _this.validate();
      formValid && _this.setState({
        isClicked: true
      });
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "addPredicate", function (field, predicateFn) {
      return function () {
        _this.setState(function (prevState) {
          return {
            predicates: _objectSpread({}, prevState.predicates, _defineProperty({}, field, predicateFn))
          };
        });
      };
    });
  ...
  _createClass(FormFACCComponent, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      var formPredicates = this.props.formPredicates;
      var fields = this.state.fields;
      this.setState(function (prevState) {
        return {
          customPredicates: _objectSpread({}, prevState.customPredicates, formPredicates(fields))
        };
      });
    }
  }, {
  ...
  return FormFACCComponent;
}(__WEBPACK_IMPORTED_MODULE_0_react__["Component"]);

var FormFACC = FormFACCComponent;
FormFACCComponent.propTypes = {
  children: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.func.isRequired
};
var withForm = function withForm(_ref4) {
  var isDynamic = _ref4.isDynamic,
      formPredicates = _ref4.formPredicates;
  return function (WrappedComponent) {
    var WithForm =
    /*#__PURE__*/
    function (_Component2) {
      _inherits(WithForm, _Component2);
      ...
      function WithForm() {
        ...
        _this2 = _possibleConstructorReturn(this, (_getPrototypeOf3 = _getPrototypeOf(WithForm)).call.apply(_getPrototypeOf3, [this].concat(args)));
        ...
        _defineProperty(_assertThisInitialized(_assertThisInitialized(_this2)), "validate", function () {
          var _this2$state = _this2.state,
              predicates = _this2$state.predicates,
              fields = _this2$state.fields,
              customPredicates = _this2$state.customPredicates;

          _this2.setState({
            errors: {}
          });

          var _Object$keys$reduce3 = Object.keys(predicates).reduce(function (acc, curr) {
            var error = !predicates[curr](fields[curr]) ? _defineProperty({}, curr, true) : {};
            return {
              errors: _objectSpread({}, acc.errors, error)
            };
          }, {
            errors: {}
          }),
              errors = _Object$keys$reduce3.errors;

          errors = Object.keys(customPredicates).reduce(function (acc, item) {
            var error = !customPredicates[item]["validator"](fields) ? _defineProperty({}, customPredicates[item]["name"], true) : {};
            return _objectSpread({}, acc.errors, error);
          }, {
        ...
        _defineProperty(_assertThisInitialized(_assertThisInitialized(_this2)), "handleChange",
        /*#__PURE__*/
        function () {
        ...
        _defineProperty(_assertThisInitialized(_assertThisInitialized(_this2)), "addPredicate", function (field, predicateFn) {
          return function () {
